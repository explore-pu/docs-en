...
## Extend the custom field {#Extend-the-custom-field}
...
And then you can use PHP editor in [model-form](https://laravel-admin.org/docs/en/model-form):
...
## Integrate CKEditor {#Integrate-CKEditor}
